...
impl BlockCounter {
    ...
    // Format a pretty message showing our block submissions stored per second.
    ...
    pub fn log(&self) {
        ...
        info!(count, per_second, "block submission stored rate");
    }
}

pub async fn report_storage_rate_periodically(block_counter: &BlockCounter) {
